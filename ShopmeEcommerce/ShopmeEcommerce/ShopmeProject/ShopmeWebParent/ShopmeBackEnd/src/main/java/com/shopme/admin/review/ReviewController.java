...
public class ReviewController {
	...
	public String listByPage(
			@PagingAndShortingParam(listName = "listReviews", moduleURL = "/reviews") PagingAndSortingHelper helper,
	...
	public String viewReview(@PathVariable("id") Integer id, Model model, RedirectAttributes ra) throws ReviewNotFoundException {
	...
	public String editReview(@PathVariable("id") Integer id, Model model, RedirectAttributes ra) throws ReviewNotFoundException {
	...
	public String deleteReview(@PathVariable("id") Integer id, RedirectAttributes ra) throws ReviewNotFoundException {
