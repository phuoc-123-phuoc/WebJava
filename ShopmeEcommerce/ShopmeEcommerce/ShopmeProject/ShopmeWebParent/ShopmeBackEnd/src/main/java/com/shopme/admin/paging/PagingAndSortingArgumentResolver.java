...
public class PagingAndSortingArgumentResolver implements HandlerMethodArgumentResolver {
	...
	public boolean supportsParameter(MethodParameter parameter) {
		...
		return parameter.getParameterAnnotation(PagingAndShortingParam.class) != null;
	}

	@Override
	public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer model,
			NativeWebRequest request, WebDataBinderFactory binderFactory) throws Exception {
		PagingAndShortingParam annotation = parameter.getParameterAnnotation(PagingAndShortingParam.class);
